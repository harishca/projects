		    				...
		    				$(document).ready(function(){
		    					$('#calendar').fullCalendar({
		    						...
		    						eventClick: function(event,element){
		    							...
		    							document.getElementById("StartTime1").value = event.start.format('HH:mm');
		    							document.getElementById("EndTime1").value = event.end.format('HH:mm');
...
<form name=deleteTimeSlot action="ts-manage" method="post"
	...
	<div class="modal fade" id="deleteTimeSlotModal" tabindex="-1">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="deleteTimeSlotTitle">Update Time
						Slot</h4>
				</div>
				<div class="modal-body">
					<input type="hidden" id="StartTime1" value="" />
					<input type="hidden" id="EndTime1" value="" />
					<label for="StartTime">Start Time:</label> <input type="time"
...
<script>
	function validate(){
		var valid = confirm('Are you sure you want to update?');	
		if (valid == true){
			...
			var params = ('StartTime1='+starttime1+'&EndTime1='+endtime1+'&StartTime2='+starttime+'&EndTime2='+endtime+'&Date='+date+'&pname='+pname);
			var xmlhttp;
			xmlhttp = new XMLHttpRequest();
			xmlhttp.onreadystatechange=function(){
				if (xmlhttp.readyState==4){
			...
			xmlhttp.setRequestHeader("Connection","close");
			xmlhttp.send(params);
			document.getElementById("result2").innerHTML = "Attempting to update time slot...";
			return false;
		}
		else {
			return false;
