...
<div>
	<ul class="nav navbar-nav">
		...
		<li><a href="#" id="showpreference"><font style="color: #e67e22" size="3">Preference</font></a></li>
	</ul>
	<ul class="nav navbar-nav navbar-right">
		<li><a href="#"><font style="color: #e67e22" size="3">You are logged in as a Student. </font></a></li>
		<li><a href="logout"><span class="glyphicon glyphicon-log-in"><font style="color: #e67e22" size="3">Logout</font></a></li>
	</ul>
</div>
</div>
</nav>
	...
	<div id="inversenavbar" class="container-fluid"
		...
		<div>
			<table class="table">
				<thead>
					<tr>
						<th><font style="color: #e67e22" size="4"><b>Upcoming
									Advising Appointment:</b></th>
						<th><font style="color: #e67e22" size="3"><b>Appointment
									Date</b></th>
						<th><font style="color: #e67e22" size="3"><b>Advising
									Type</b></th>
						<th><font style="color: #e67e22" size="3"><b>Start
									Time</b></th>
						<th><font style="color: #e67e22" size="3"><b>End
									Time</b></th>
					</tr>
				</thead>
				<tr>
